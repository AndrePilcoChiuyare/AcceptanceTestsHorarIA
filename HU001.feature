...
Given que el <usuario> se encuentra en la sección de Generar/Modificar horario
And mantenga presionado sobre una <actividad> de su cronograma
...
And permitirá que el <usuario> escoja un <color>
Example:
